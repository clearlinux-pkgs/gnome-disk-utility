...
Source0  : https://download.gnome.org/sources/gnome-disk-utility/46/gnome-disk-utility-46.1.tar.xz
...
%prep
%setup -q -n gnome-disk-utility-46.1
cd %{_builddir}/gnome-disk-utility-46.1
%patch -P 1 -p1
pushd ..
cp -a gnome-disk-utility-46.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726763852
